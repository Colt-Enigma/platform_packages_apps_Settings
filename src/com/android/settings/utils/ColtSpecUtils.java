...
public class ColtSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String COLT_CPU_MODEL_PROPERTY = "ro.colt.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelColt = SystemProperties.get(COLT_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelColt.isEmpty()) {
            return cpuModelColt;
