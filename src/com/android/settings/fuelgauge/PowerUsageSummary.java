...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.colt.ColtUtils.mccCheck(getContext()) ?
                com.android.internal.util.colt.ColtUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.colt.ColtUtils.batteryTemperature(getContext(), false) + "°C");
